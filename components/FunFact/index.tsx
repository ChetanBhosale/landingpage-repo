      ...
      <section className="px-4 py-20 md:px-8 lg:py-22.5 2xl:px-0">
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="animate_top mx-auto mb-12.5 px-4 text-[#ED7014] text-center md:w-4/5 md:px-0 lg:mb-17.5 lg:w-2/3 xl:w-1/2"
          >
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Joinis</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: { opacity: 0, y: -20 },
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Happy Employees</p>
            </motion.div>
          </div>
        </div>
      </section>
