      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `PLATFORMS`,
              subtitle: `Where We Find Top Talent`,
              description: `Explore the platforms we use to discover skilled professionals from around the globe. These trusted sources help us connect with the best in the industry.`,
            }}
          />
