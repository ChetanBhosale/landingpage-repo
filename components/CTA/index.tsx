          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300">
                At this stage, I am convinced that nothing we do is more
                important than hiring and developing people. At the end of the
                day, you bet on people, not just on strategies.
              </p>
            </motion.div>
            <motion.div
              variants={{
